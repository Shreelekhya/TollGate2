...
public class PlanYourTrip extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
...
if(t.equals(f))
{
    Toast.makeText(PlanYourTrip.this,"cannot have same from and two places",Toast.LENGTH_LONG).show();
}
else
    ...
    public class PlanUrTrip2  extends AsyncTask<String,Void,String> {
        ...
        public void onPostExecute(String result) {
            ...
            {
                Intent intent = new Intent(PlanYourTrip.this, MainPage.class);
                Toast.makeText(context, "Cannot have same from and to place...", Toast.LENGTH_LONG).show();
